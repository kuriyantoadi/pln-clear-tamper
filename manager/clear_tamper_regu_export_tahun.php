...
$cek_data = mysqli_query($koneksi, "SELECT * FROM `tb_clear_tamper_regu` WHERE YEAR(`tgl_permintaan`) = $tahun");
...
?>
	...
	<table id="tabel_js" class="table table-primary">
		...
		$data = mysqli_query($koneksi,"SELECT * FROM `tb_clear_tamper_regu` 
		...
		<tr>
            ...
            <td><?php echo $d['nama_petugas_2']; ?></td>
            <td><?php echo $d['nama_petugas_3']; ?></td>
