<?php include('../template/header-operator.php') ?>
<?php include('../template/header-operator-menu.php') ?>
...
<div class="container-xl px-4 mt-n10">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <?php include('regu_clear_tamper_modal.php') ?>
               ...
               include '../koneksi.php';
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?= $d['nama_regu'] ?></td>
                        <td>
                            <a class="btn btn-danger btn-sm" href="regu_clear_tamper_hapus.php?id_regu=<?php echo $d['id_regu']; ?>" onclick="return confirm('Anda yakin Hapus data nama regu)'"><i data-feather="trash-2"></i></a>
