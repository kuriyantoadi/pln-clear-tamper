    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="clear_tamper_regu_tambah.php" method="post" id="formPengajuan" enctype="multipart/form-data">
...
<div class="modal fade" id="edit<?php echo $d['id_regu'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form action="clear_tamper_regu_edit.php" method="post" id="formEdit" enctype="multipart/form-data">
                    <!-- Menyimpan ID pengguna yang sedang diedit -->
                    <table class="table">
                        <tr>
                            <td>Nama Regu</td>
